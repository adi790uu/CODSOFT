  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 w-4/5 m-auto mt-10'>
      ...
      <div className='p-4 md:ml-10'>
        <p className='font-body font-semibold text-3xl text-neutral-300 pl-4'>
          Product Name
        </p>
        ...
        <div className='mt-6 rounded-lg shadow-md shadow-neutral-700 overflow-x-auto overflow-y-auto w-full'>
          <p className='pl-4 pt-4 font-body'>Product Description :</p>
          <div className='divider'></div>
          <article className='prose pl-4 pr-4 pb-4 font-body tracking-wide h-96  font-normal text-justify text-lg'>
